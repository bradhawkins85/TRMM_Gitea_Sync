...
def _github_description(existing_description: str) -> str:
    """
    Return *existing_description* with ``[GitHub]`` prepended.
    ...
    if description.startswith(GITHUB_DESCRIPTION_PREFIX):
        return description
    if description:
        return f"{GITHUB_DESCRIPTION_PREFIX} {description}"
    return GITHUB_DESCRIPTION_PREFIX


def sync_script(github_script: dict, trmm_index: Dict[Tuple[str, str], dict]) -> str:
    """
